...
artpaint/tools/ToolScript.cpp artpaint/tools/ToolSelectionWindow.cpp artpaint/tools/ToolSetupWindow.cpp artpaint/tools/TransparencyTool.cpp artpaint/tools/CloneTool.cpp \
...
LOCALES= ca cs de en_AU en_GB en es_419 es fr fur it ja nb nl sv tr uk
